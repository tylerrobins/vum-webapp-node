...
router.post('/api/cfeTrainingQuiz', async (req, res, next) => {
  ...
  if (data.q8 == "q8option3") correctAnswers++;
  // let q8Correct = true;
  ...
  try {
    ...
    cfeQuizData.q1 = data.q1;
    cfeQuizData.q2a1 = data.q2[0];
    cfeQuizData.q2a2 = data.q2[1];
    cfeQuizData.q2a3 = data.q2[2];
    cfeQuizData.q3 = data.q3;
    cfeQuizData.q4 = data.q4;
    cfeQuizData.q5 = data.q5;
    cfeQuizData.q6 = data.q6;
    cfeQuizData.q7 = data.q7;
    // cfeQuizData.q8step1 = data.q8.step1;
    // cfeQuizData.q8step2 = data.q8.step2;
    // cfeQuizData.q8step3 = data.q8.step3;
    cfeQuizData.q8 = data.q8;
    cfeQuizData.q9 = data.q9;
    cfeQuizData.q10 = data.q10;
    cfeQuizData.idNumber = data.idNumber;
  } catch {
    let cfeQuizData = {
      partitionKey: "",
      rowKey: data.phoneNumber,
...
// CONTROLLER
async function cfeRegNTraining(req, res, next) {
  const xBinuDid = req.query['x-binu-did'];
  if (!xBinuDid) {
  ...
  try {
    ...
    // if (entity.admin) { //THIS IS TO LIMIT ACCESS
    //   return res.render('cfeTraining', { number: entity.rowKey });
    // } else {
    //   return res.render('cfeRegistered');
    // }
    return res.render('cfeTraining', {number : entity.rowKey}); //THIS IS FOR WHEN THE ADMIN CHECK IS REMOVED
  } catch (error) {
    console.log(`ERROR: ${error}`);
  }
  return res.render('cfeCampaign', { xBinuDid: xBinuDid, number: userMetaDataMoya.number, });
}
